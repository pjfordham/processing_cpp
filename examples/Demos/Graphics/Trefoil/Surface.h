...
inline PShape createTrefoil(float s, int ny, int nx, PImage tex) {
  PVector p0, p1, p2;
  PVector n0, n1, n2;
  float u0, u1, v0, v1;
...
// parameters (u, v)
inline PVector evalNormal(float u, float v) {
...
// parameters (u, v)
inline PVector evalPoint(float u, float v) {
  float a = 0.5;
  float b = 0.3;
  float c = 0.5;
  float d = 0.1;
